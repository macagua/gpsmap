...
class gps_positions(models.Model):
    ...
    servertime = fields.Datetime(string = "Server Time")
    devicetime = fields.Datetime(string = "Device Time")
    fixtime = fields.Datetime(string = "Error Time")
    latitude = fields.Float(string = "Latitude", digits = (3, 6))
    longitude = fields.Float(string = "Longitude", digits = (3, 6))
    altitude = fields.Float(string = "Altitude", digits = (6, 2))
    speed = fields.Float(string = "Speed", digits = (3, 2))
    course = fields.Float(string = "Course", digits = (3, 2))
    batery = fields.Float(string = "Batery", digits = (3, 2))
    distance = fields.Float(string = "Distance", digits = (7, 3))
    totalDistance = fields.Float(string = "Total Distance", digits = (10, 3))
    gas = fields.Float(string = "Gas", digits = (5, 2))
    status = fields.Char(string = "Type", size = 50)
    event = fields.Char(string = "Event", size = 70)
